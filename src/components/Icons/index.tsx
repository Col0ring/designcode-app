...
interface IconsProps<T = any> extends SVGProps<T> {}

export const NotificationIcon: React.FC<IconsProps> = (props) => {
  return (
    <Svg
      width={24}
      height={24}
...
export const PlayIcon: React.FC<IconsProps> = (props) => (
  <Svg height={38.15} width={38.15} {...(props as any)}>
    <Path
      opacity={1}
